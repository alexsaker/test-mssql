...
function run(withPoolCreation) {
    ...
    if (withPoolCreation) {
        ...
        myPool.connect()
            ...
            .then(res => {
                console.log('Number of elements gathered: ' + res.recordsets[0][0]['count']);
...
function selectAllUsers() {
    ...
    .query(`SELECT COUNT(@id) AS 'count' FROM [testmssql].[dbo].[TestUser];SELECT @id,@company,@email,@about,@friends,@favoriteFruit FROM  [testmssql].[dbo].[TestUser]`);
}
